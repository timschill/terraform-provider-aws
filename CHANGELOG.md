...
- resource/aws*cloudformation_stack_set: Support resource import with `call_as = "DELEGATED_ADMIN"` via \_StackSetName*,_CallAs_ syntax for `import` block or `terraform import` command ([#19092](https://github.com/hashicorp/terraform-provider-aws/issues/19092))
- resource/aws*cloudformation_stack_set_instance: Support resource import with `call_as = "DELEGATED_ADMIN"` via \_StackSetName*,_AccountID_,_Region_,_CallAs_ syntax for `import` block or `terraform import` command ([#19092](https://github.com/hashicorp/terraform-provider-aws/issues/19092))
...
- resource/aws*vpc_endpoint: Fix `InvalidParameter: PrivateDnsOnlyForInboundResolverEndpoint not supported for this service` errors creating S3 \_Interface* VPC endpoints ([#32355](https://github.com/hashicorp/terraform-provider-aws/issues/32355))
